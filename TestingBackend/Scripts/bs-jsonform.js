...
class JsonForm {
    ...
    _buildForm(json, instance="default") {
        ...
        <div class="float-center mt-3">
            <button type="submit" class="btn btn-secondary btn-lg btn-block">`+json.submit_button_text+`</button>
        </div>`
        ...
        switch (json.field.type) {
            ...
            case "file":
                ...
                <div class="custom-file">
                    ...
                    <label class="custom-file-label" for="`+id+`" id="`+id+`-Label"></label>
                </div>
                </div>
                `
                break
        ...
        switch (event) {
            ...
            case "initialize":
                ...
                <div class="`+addBtnClass+`">
                    <button id="`+id+`-AddBtn" type="button" class="w-100 btn btn-outline-secondary">+</button>
                </div>
                `
            ...
            case "getValues":
                ...
                for (ct = 1; ct <= fieldInstance.field.ct; ct++) {
                    if (!("fields" in fieldInstance.field)) {
                        ...
                        values[1][id.substring(21,id.length-1)+ct] = this._inputValue(domId).Value
                    } else {
                        fieldInstance.field.fields.forEach((item, index) => {
